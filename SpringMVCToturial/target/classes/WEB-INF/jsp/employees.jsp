...
<html>
  <head>
   ...
   <body>
      ...
      <form:form method="post" action="/SpringMVCToturial/employee.html" commandName="employee">
        <div class="table-responsive">
          <table class="table table-bordered" style="width: 300px">
            ...
            <tr>
              <td>Salary :</td>
              <td><form:input type="text" path="sal" /></td>
            </tr>
            <tr>
              <td>Department :</td>
     ...
     <h3>List of Employees</h3>
       <table class="table table-bordered" style="width: 300px">
         ...
         <tr>
           ...
           <td width="60" align="center">${employee.sal}</td>
